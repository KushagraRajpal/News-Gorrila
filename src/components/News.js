...
const News = (props) => {
    ...
    useEffect(() => {
        updateNews();
        document.title = `${capitailise(props.category)} - NewsGorrila`;
    ...
    return (
        <>
            <h1 className="text-center" style={{ margin: '35px 0px', marginTop: '90px' }}>NewsGorrila - Top {capitailise(props.category)} Headlines </h1>
            {loading && <Spinner />}
            <InfiniteScroll
