...
export class News extends Component {
    ...
    async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=9f3f7a9cd5c346bdaf9eb471bf562403&page=${this.state.page}&pageSize=${this.props.pageSize}`
